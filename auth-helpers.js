...
function getAccessToken() {
    return __awaiter(this, void 0, void 0, function* () {
        let body = {
            client_id: config_1.MicrosoftAppID,
            grant_type: 'client_credentials',
            resource: 'https://graph.microsoft.com',
            client_secret: config_1.MicrosoftAppSecret
        };
        let options = {
            method: "POST",
            headers: {
        ...
        return node_fetch_1.default(`https://login.windows.net/${config_1.TenantDomain}/oauth2/token`, options).then((rawResponse) => {
